    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal-box" onClick={e=>e.stopPropagation()}>
        ...
        <div className="modal-body" ref={bodyRef}>
          ...
          <h4>4. 개인정보의 파기</h4>
          <p>보유 기간이 경과하거나 처리 목적이 달성된 개인정보는 지체 없이 파기합니다. 전자 파일 형태의 정보는 복구·재생이 불가능한 방법으로 영구 삭제하며, 출력물 등은 분쇄 또는 소각하여 파기합니다.</p>
          <h4>5. 개인정보의 제3자 제공</h4>
          <p>회사는 수집한 개인정보를 원칙적으로 제3자에게 제공하지 않습니다. 다만, 다음의 경우는 예외로 합니다.</p>
          <ul>
            <li>정보주체의 별도 동의가 있는 경우</li>
            <li>법률에 특별한 규정이 있거나 법령상 의무 이행을 위해 불가피한 경우</li>
          </ul>
          <h4>6. 개인정보 처리의 위탁</h4>
          <p>회사는 현재 개인정보 처리 업무를 외부에 위탁하지 않습니다. 향후 위탁이 발생하는 경우 위탁 대상자 및 업무 내용을 사전에 고지합니다.</p>
          ...
          <p className="modal-note">※ 위 권리 행사는 서면, 전화, 전자우편 등을 통해 하실 수 있으며 회사는 이에 대해 지체 없이 조치합니다.</p>
          <h4>8. 개인정보 보호책임자</h4>
          <table className="modal-table">
            <tbody>
              ...
              <tr><td>연락처</td><td>010-8386-2949</td></tr>
            </tbody>
          </table>
          <p className="modal-note">※ 개인정보 침해에 대한 신고 및 상담은 개인정보 보호위원회(privacy.go.kr / 국번없이 182) 또는 한국인터넷진흥원(118.go.kr / 국번없이 118)에 문의하실 수 있습니다.</p>
          <h4>9. 동의 거부 권리 및 불이익</h4>
          <p>위 개인정보 수집·이용에 대한 동의를 거부하실 수 있습니다. 다만, <strong>필수 항목(이름, 연락처)</strong>에 동의하지 않으실 경우 가맹 상담 신청 서비스 이용이 제한됩니다.</p>
        </div>
...
export default function InquiryForm() {
  ...
  if (success) return (
    <section className="inquiry" id="inquiry">
      <div className="inquiry__card" style={{ textAlign:'center', padding:'60px 40px' }}>
        ...
        <p style={{ fontSize:14, color:'#666', lineHeight:1.8 }}>1~2 영업일 내로 담당자가 연락드릴 예정입니다 😊</p>
      </div>
    </section>
  )
