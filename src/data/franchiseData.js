...
export const REASONS = [
  { num:'01', title:'소자본 창업', desc:'4평부터 시작 가능. 총 창업비 약 2,000만원 내외. 중형차 한 대 비용으로 내 매장을 오픈할 수 있습니다.' },
  { num:'02', title:'2인 운영 가능', desc:'최적화된 동선 설계로 부부 2명 운영 가능. 알바 불필요. 인건비 부담을 최소화합니다.' },
  { num:'03', title:'검증된 수익 구조', desc:'상일동 직영점 기준 일 매출 167만원 이상. 월 순수익 1,000만~1,700만원(3~5월 실측). 투자비 6개월 내 회수 목표.' },
